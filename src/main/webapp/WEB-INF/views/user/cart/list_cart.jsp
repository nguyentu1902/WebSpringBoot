	...
	<div class="row">
		<div class="span12">
			...
			<div class="well well-small">
				<h1>
					Giỏ hàng <small class="pull-right"> ${ TotalQuantyCart } sản phẩm trong giỏ </small>
				</h1>
				<hr class="soften" />
					...
					<tbody>
							...
							<c:forEach var="item" items="${ Cart }">
								...
								<tr>
									...
									<td><button data-id="${ item.key }" class="btn btn-mini btn-danger edit-cart" type="button"> <span class="icon-edit"> </span></button></td>
